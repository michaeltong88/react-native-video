...
const Video = forwardRef<VideoRef, ReactVideoProps>(
  (
    ...
    const _onShowControls = useCallback(
      (e: NativeSyntheticEvent<any>) => {
        onShowControls?.(e.nativeEvent);
      },
      [onShowControls],
    );

    const _onHideControls = useCallback(
      (e: NativeSyntheticEvent<any>) => {
        onHideControls?.(e.nativeEvent);
      },
      [onHideControls],
    );
    ...
    return (
      <View style={style}>
        <NativeVideoComponent
          ...
          onShowControls={
            onShowControls ? _onShowControls : undefined
          }
          onHideControls={
            onHideControls ? _onHideControls : undefined
          }
          viewType={_viewType}
        />
        {_renderPoster()}
